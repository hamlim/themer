...
},{"./cjs/react-dom.development.js":"node_modules/react-dom/cjs/react-dom.development.js"}],"src/reducers.js":[function(require,module,exports) {
"use strict";
...
function spaceReducer(state, action) {
  ...
  if (action.type === "add") {
    if (state && state.length && state.some(isValue)) {
      return Array.from({
        ...
        if (state[index]) {
          return [].concat(_toConsumableArray(acc), [state[index]]);
        }
  ...
  throw new Error("Invalid action dispatched to spaceReducer: ".concat(JSON.stringify(action), ".\n\nAllowed actions are: 'update', 'add'."));
}
...
function appReducer(state, action) {
  ...
  throw new Error("Invalid action dispatched to appReducer: ".concat(JSON.stringify(action), ".\n\nAllowed actions are: 'update-space'."));
}
...
function App() {
  ...
  return _react.default.createElement("h1", null, "Testing");
}
},{"react":"node_modules/react/index.js","./reducers.js":"src/reducers.js"}],"src/index.js":[function(require,module,exports) {
"use strict";
...
_reactDom.default.render(_react.default.createElement(_app.default, null), document.querySelector("#body"));
